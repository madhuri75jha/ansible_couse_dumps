...
description: >-
    ...
    https://docs.oracle.com/en-us/iaas/tools/oci-ansible-collection/latest/collections/oracle/oci/oci_os_management_hub_managed_instance_analytic_content_facts_module.html)
...
class ManagedInstanceAnalyticContentFactsHelperGen(OCIResourceFactsHelperBase):
...
ManagedInstanceAnalyticContentFactsHelperCustom = get_custom_class(
    "ManagedInstanceAnalyticContentFactsHelperCustom"
)


class ResourceFactsHelper(
    ManagedInstanceAnalyticContentFactsHelperCustom,
    ManagedInstanceAnalyticContentFactsHelperGen,
):
    pass
