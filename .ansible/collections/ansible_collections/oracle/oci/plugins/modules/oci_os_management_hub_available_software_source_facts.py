...
DOCUMENTATION = """
---
module: oci_os_management_hub_available_software_source_facts
description: >-
    Due to size constraints we have not included the documentation in the module. Please check L(here,
    https://docs.oracle.com/en-us/iaas/tools/oci-ansible-collection/latest/collections/oracle/oci/oci_os_management_hub_available_software_source_facts_module.html)
...
class AvailableSoftwareSourceFactsHelperGen(OCIResourceFactsHelperBase):
    ...
    def list_resources(self):
        ...
        return oci_common_utils.list_all_resources(
            self.client.list_managed_instance_available_software_sources,
